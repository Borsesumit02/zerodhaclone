...
function Hero() {
    return (  
        <div className='container p-5 pb-0 m-5 '>
            <div className='row text-center'>
                <h1 className='fs-4 p-5  m-4'>We pioneered the discount broking model in India. <br />
Now, we are breaking ground with our technology.</h1>

            </div>

            <div  style={{fontSize:"17px", lineHeight:"1.8rem"}}  className='row border-top m-5 p-5'>
                <div className='col-6 p-5 pb-0  '>
